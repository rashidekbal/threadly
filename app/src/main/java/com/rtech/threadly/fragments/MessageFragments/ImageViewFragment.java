...
public class ImageViewFragment extends Fragment {
    FragmentImageViewBinding mainXml;
    Bundle data;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        mainXml=FragmentImageViewBinding.inflate(inflater,container,false);
        init();
    ...
    private void setUserdata() {
        ...
        Glide.with(requireActivity()).load(mediaUrl).placeholder(R.drawable.post_placeholder).into(mainXml.imagePreviewView);
