...
public class Core {
    ...
    public static void init(Context context) {
        ...
        notificationManager.createNotificationChannel(new NotificationChannel(Constants.MEDIA_UPLOAD_CHANNEL.toString(),
                "media Upload Notification", NotificationManager.IMPORTANCE_DEFAULT));
        notificationManager
                .createNotificationChannel(new NotificationChannel(Constants.MESSAGE_RECEIVED_CHANNEL.toString(),
                        "for receiving messages", NotificationManager.IMPORTANCE_HIGH));
        notificationManager.createNotificationChannel(new NotificationChannel(Constants.MISC_CHANNEL.toString(), "misc",
    ...
    public static Emitter.Listener StoC_Listener = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            ...
            String ConversationId = object.optString("senderUuid")
            ...
            Executors.newSingleThreadExecutor().execute(() -> {
                ...
                if (History == null) {
                    DataBase.getInstance().historyOperator().insertHistory(new HistorySchema(ConversationId, username,
                            userid, profile, senderUuid, latestMsg, ReUsableFunctions.getTimestamp()));
                    Log.d("Stoc", "call:  added new Conversation");
                } else {
                    DataBase.getInstance().historyOperator().updateTimeStamp(ConversationId,
    ...
    public static void startSocketEvents() {
        ...
        SocketManager.getInstance().getSocket().emit("onConnect",
                getPreference().getString(SharedPreferencesKeys.UUID, "null"));
    ...
    public static void sendCtoS(String uuid, String msg, String type, String link, int postId,
            @Nullable String notificationText) throws JSONException {
