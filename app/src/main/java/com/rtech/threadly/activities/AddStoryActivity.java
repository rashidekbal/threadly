...
import com.rtech.threadly.databinding.ActivityAddStoryBinding;
import com.rtech.threadly.fragments.AddPostMainFragment;
import com.rtech.threadly.fragments.PostAddCameraFragment;
import com.rtech.threadly.fragments.storiesFragment.UploadStoryFinalFragment;
...
{
    ActivityAddStoryBinding mainXml;
    ...
    private void checkPermissionsAndStartMain() {
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.TIRAMISU){
            if(!PermissionManagementUtil.isAllPermissionGranted(AddStoryActivity.this, Permissions.AddPostPermissionsApi33AndAbove)){
                PermissionManagementUtil.requestPermission(AddStoryActivity.this, Permissions.AddPostPermissionsApi33AndAbove,permissionCode);
            }else{
                openMainFragment();
            }

        }else{
            if (!PermissionManagementUtil.isAllPermissionGranted(AddStoryActivity.this,Permissions.AddPostPermissionsApiBelow33)){
                PermissionManagementUtil.requestPermission(AddStoryActivity.this,Permissions.AddPostPermissionsApiBelow33,permissionCode);
            }else{
                openMainFragment();
            }
