...
public class ProfileViewModel extends AndroidViewModel {
    ...
    public ProfileViewModel(@NonNull Application application) {
        super(application);
        this.profileManager=new ProfileManager(application);
        this.postsManager=new PostsManager(application);
        this.loginInfo=application.getSharedPreferences(SharedPreferencesKeys.SHARED_PREF_NAME, Application.MODE_PRIVATE);
    }
